import CreateExpenditureTransactionForm from "~/components/forms/transaction/create-expenditure-transaction-form";
...
export default function ExpenditureTransactionPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div className="text-center">
          ...
          <p className="text-base-content/70">
            Record equipment expenditures and usage
          </p>
        </div>

        <CreateExpenditureTransactionForm />
